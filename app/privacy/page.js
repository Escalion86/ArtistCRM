    ...
    <main className="bg-white">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-12 text-sm text-gray-700">
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            — Avito, VK, Novofon и иные явно подключенные пользователем сервисы
            — только для выполнения выбранной интеграции, например получения
            переписки или обработки записи звонка. Состав передачи определяется
            назначением и настройками конкретной интеграции.
          </p>
          <p>
