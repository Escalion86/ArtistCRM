...
2. После E2-T6 расширить API-документацию примерами реальных интеграций.
3. Подготовить короткий onboarding-блок в UI `Интеграции` с ссылкой на документацию API.
