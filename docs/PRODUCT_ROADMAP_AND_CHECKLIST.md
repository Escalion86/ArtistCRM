...
2. Продолжить Sprint 2 с E2-T6 (история коммуникаций и напоминаний по заявке/мероприятию).
3. После E2-T6 расширить API-документацию примерами реальных интеграций.
4. Подготовить короткий onboarding-блок в UI `Интеграции` с ссылкой на документацию API.
