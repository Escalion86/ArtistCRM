...
- [x] E1-T6 Финансовый статус задатка (`none|partial|received`, `depositAmount`, `depositDueAt`)
...
2. Перейти к Sprint 2 (документы и входящие интеграции).
3. В Sprint 2 начать с E2-T1 (шаблон стандартного договора).
