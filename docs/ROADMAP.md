...
- [x] M1-T1 Архитектурный дизайн mobile-приложения (auth, API слой, навигация, offline стратегия)
- [x] M1-T2 Bootstrap Expo-проекта и базовая авторизация
- [x] M1-T3 Экран `Задачи контактов` (просрочено/сегодня/завтра) с быстрыми действиями
- [x] M1-T4 Push-уведомления (Expo Notifications) для контактов/задатков/сроков
- [x] M1-T5 Экран мероприятий (список предстоящих с данными из API)
...
- [x] Голосовой ввод события: кнопка микрофона в форме, Web Speech API + ИИ-парсинг через `/api/events/ai-draft`
