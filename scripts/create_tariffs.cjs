...
async function main() {
  ...
  const tariffSchema = new mongoose.Schema({
    ...
    allowAvitoIntegration: Boolean, allowVkIntegration: Boolean,
  }, { timestamps: true });
  ...
  const tariffs = [
    { title: 'Базовый', subtitle: 'Для небольших агентств', price: 1490,
      ...
      hidden: false, eventsPerMonth: 50, allowCalendarSync: false, allowStatistics: false, allowDocuments: true, allowTelephony: false, allowAi: false, allowAvitoIntegration: false, allowVkIntegration: false },
    { title: 'Профи', subtitle: 'Для растущих агентств', price: 2990,
      ...
      hidden: false, eventsPerMonth: 0, allowCalendarSync: true, allowStatistics: true, allowDocuments: true, allowTelephony: true, allowAi: false, allowAvitoIntegration: true, allowVkIntegration: true },
    { title: 'Бизнес', subtitle: 'Для крупных агентств', price: 5990,
      ...
      hidden: false, eventsPerMonth: 0, allowCalendarSync: true, allowStatistics: true, allowDocuments: true, allowTelephony: true, allowAi: true, allowAvitoIntegration: true, allowVkIntegration: true },
  ];
